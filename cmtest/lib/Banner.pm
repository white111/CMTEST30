...
#
# Version:    (See below) $Id: Banner.pm,v 1.1 2008/02/22 21:00:51 joe Exp $
#
# Changes:
#
#
...
#
################################################################################
my $Ver= '1.2 1/31/2008'; # Updated versioning
my $CVS_Ver = ' [ CVS: $Id: Banner.pm,v 1.1 2008/02/22 21:00:51 joe Exp $ ]';
$Version{'Banner'} = $Ver . $CVS_Ver;
