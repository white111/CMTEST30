...
# Descr:      P[t-h]TML ! ;^)
#
# Version:    (See below) $Id: PTML.pm,v 1.4 2008/02/21 00:00:27 joe Exp $
#
# Changes:    v5 - 11/11/05  Export Print_Log, cleaned HTML
#
#
# Still ToDo:
#
...
#
################################################################################
my $Ver= 'v5 1/31/2008'; # Updated versioning
my $CVS_Ver = ' [ CVS: $Id: PTML.pm,v 1.4 2008/02/21 00:00:27 joe Exp $ ]';
$Version{'PTML'} = $Ver . $CVS_Ver;
...
our @EXPORT_OK = qw( Indent Init_CGI Body Debug Comment PrintLog );
...
#                &Body ("<TD style=\"background: #E0D0D0\">$Data</TD>");
        }
